    ...
    <div className="header section__padding" id="home">
      <div className="header-content">
        ...
        <div className="header-content_icons">
          <a href="https://github.com/Arlwin" target="_blank" rel="noreferrer">< RiGithubLine /></a>
          <a href="https://www.linkedin.com/in/arlwinfajardo" target="_blank" rel="noreferrer"><RiLinkedinBoxFill /> </a>
          <a href="mailto:arlwin.fajardo@gmail.com" target="_blank" rel="noreferrer">< MdOutlineMailOutline /></a>
        </div>
      </div>
